...
keep growing. It might be confusing with the notation but that is only
to emphasise that it behaves like the inverse [change notation, e.g.
$\Psi^\dagger$?]}
%
...
\note{This looks very MATLAB.. I don't like it [saves space]}
...
\end{equation}
%
\note{I find the $x^+\approx Ax+Bu$ notation very misleading! I prefer
  $=$ since we will take it as an equality after all not handling
  discretisation errors at all.. [OK - agreed]}
...
extremal values.. That's obviously not the case.. [We can assume this
...
$\alpha_3$ and is blown up by normalising. [some comment is needed in
the text]}
